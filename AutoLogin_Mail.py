...
postHeader={'Accept':'*/*',
	...
	'Pragma':'no-cache',
	'Referer':'http://lan.upc.edu.cn/eportal/index.jsp?wlanuserip=180.201.132.180&wlanacname=&nasip=172.22.242.21&wlanparameter=74-7d-24-2c-82-30&url=http://www.upc.edu.cn/&userlocation=ethtrunk/62:1281.0',
	'User-Agent':'Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.102 Mobile Safari/537.36'
}
postData={'userId':'S17020242',
	'password':'090514',
	'service':'unicom',
	'queryString':'',
	'operatorPwd':'',
